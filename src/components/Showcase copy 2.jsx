...
function Card({i,img,title,targetScale,range,progress}) {
   ...
   return(   
   <motion.div ref={targetRef} style={{scale:scaleCard,top:`calc(4% + ${i*35}px)`}} className= ' my-4 mx-auto w-[100%%] rounded-[20px] overflow-hidden noise h-[90vh] sticky top-[0px]'>
