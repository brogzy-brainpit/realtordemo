...
function Landing() {
  ...
  exit:{y:"100%"}}
      ...
      const slideUp={
        initial:{height:"0px"},
    enter:(index)=>({height:"300px",transition:{duration:0.5,delay:2.6}}),
    exit:{height:"300px"}}
...
{/* the animated line */}
  {/* <motion.hr variants={slideUp}  initial="initial" animate={inView?"enter":"exit"} exit="exit" className='border-0 rounded-full md:w-[2.5px] w-[200px] h-[200px] md:h-[2px]  bg-[white]'></motion.hr> */}
...
{/* the animated line */}
 ...
 <motion.div variants={reveal2}  initial="initial" animate={inView?"enter":"exit"} exit="exit"  className='flex gap-8  md:flex-col flex-row  justify-end items-center py-6 px-2'>
  ...
  <div ref={textRef} className=' bg-slate500 overflow-hidden relative bg-slate-30 md:hidden flex flex-row'>
    <motion.div variants={up1}  initial="initial" animate={inView?"enter":"exit"} exit="exit"  className='flex gap-8  md:flex-col flex-row justify-start items-center py-6 px-2'>
      <Magnetic className="cursor-pointer">
        <Link href={"/"} target='blank'>
      <img src={insta.src} className='w-[25px]'/>
        </Link>
    ...
    <motion.div variants={up2}  initial="initial" animate={inView?"enter":"exit"} exit="exit"  className='flex gap-8  md:flex-col flex-row justify-start items-center py-6 px-2'>
         <Magnetic className="cursor-pointer">
        <Link href={"/"} target='blank'>
      <img src={facebook.src} className='w-[25px]'/>
        </Link>
 ...
 <motion.div variants={up1}  initial="initial" animate={inView?"enter":"exit"} exit="exit"  className='flex gap-8  md:flex-col flex-row  justify-end items-center py-6 px-2'>
      <Magnetic className="cursor-pointer">
        <Link href={"/"} target='blank'>
      <img src={twitter.src} className='w-[25px]'/>
        </Link>
